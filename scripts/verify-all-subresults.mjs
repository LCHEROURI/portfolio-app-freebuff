...
export const SUBRESULT_LABELS = {
  ...
  'reports-pdf-session': 'Owner session mints + Reports auth gate releases',
  'reports-pdf-page': 'Saved report row with a Download PDF button renders',
  'reports-pdf-click': 'Button click accepted with no error toast',
  'reports-pdf-download': 'Browser download lands as a real %PDF- file',
